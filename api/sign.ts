...
export default async function handler(req: any, res: any) {
  ...
  const htmlBody = `<div style="font-family:Arial,sans-serif;max-width:600px">
    <h2 style="color:#E8930C;margin-bottom:4px">Proposal accepted ✍️</h2>
    ...
    ${documentUrl ? `<p><a href="${escapeHtml(documentUrl)}" style="color:#E8930C">Open the signed document</a></p>` : ''}
    <p style="color:#5A5A5A;font-size:12px">The customer consented to sign electronically.
    Keep this email — it is the record of the acceptance.</p>
  </div>`;
